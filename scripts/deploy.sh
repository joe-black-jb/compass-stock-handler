...
docker build --platform linux/amd64 -t compass-stock-handler:${IMAGE_TAG} .

### ECR に push するためにタグを付け替える
docker tag compass-stock-handler:${IMAGE_TAG} ${AWS_ACCOUNT_ID}.dkr.ecr.ap-northeast-1.amazonaws.com/compass:${IMAGE_TAG}
